        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Link href="/" onClick={(e) => handleNavClick(e, 'home')} className="flex items-center space-x-2">
              <Image src="/assets/logo.png" height={50} width={50} alt="byteory Logo" className="hover:opacity-90 transition-opacity" />
              <span className="hidden sm:inline-block text-lg font-semibold text-white">Byteory</span>
